...
const Navbar : React.FC = () => {
  ...
  return (
    <nav className={`${visible ? "" : "-translate-y-full"} fixed bg-transparent z-10 backdrop-blur-sm w-full duration-300 ease-in-out flex justify-between items-center px-11 md:px-4 py-4 md:justify-evenly`}>
        <Link href="/" className='bg-slate-800 w-[93px] py-1 px-[7px] text-white text-base rounded font-bold'>ZM <span className='bg-white text-black rounded px-1'>Lab</span></Link>
        ...
        <div className='hidden sosmed justify-center gap-4 md:flex'>
         <a href="https://www.instagram.com/ainulzml/" target='_blank' className='duration-300 hover:text-teal-500'>
        ...
        <a href="mailto:ainulzml@gmail.com" target='_blank' className='duration-300 hover:text-teal-500'>
        ...
        <a href="https://github.com/ainulzml" target='_blank' className='duration-300 hover:text-teal-500'>
