  ...
  return (
    ...
    {open && (
      ...
      {links.map((link,i) => (
       ...
       <motion.a initial={{scale:0}} animate={{scale:1}} transition={{delay:0.1}} href="https://www.instagram.com/ainulzml/"target='_blank' className='duration-300 text-white hover:text-teal-500'>
      ...
      <motion.a initial={{scale:0}} animate={{scale:1}} transition={{delay:0.2}} href="mailto:ainulzml@gmail.com" className='duration-300 text-white hover:text-teal-500'>
      ...
      <motion.a initial={{scale:0}} animate={{scale:1}} transition={{delay:0.3}} href="https://github.com/ainulzml" target='_blank' className='duration-300 text-white hover:text-teal-500'>
